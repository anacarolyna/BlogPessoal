	...
	public OpenAPI springBlogPessoalOpenAPI() {
		...
		return new OpenAPI()
				.info(new Info().title("Projeto Blog Pessoal")
					    ...
					    .name("Ana Carolyna") // repositório do projeto
						.url("https://github.com/anacarolyna/BlogPessoal")
						.email("dinizanacarolyna@gmail.com")))
				        .externalDocs(
						new ExternalDocumentation()
						.description("Meu Linkedin")
						.url("https://www.linkedin.com/in/anacarolynadiniz/"));
	}
